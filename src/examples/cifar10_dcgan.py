...
"""
@title           :examples/cifar10_dcgan.py
@author          :ch
...
This script shows how to use the class DCGAN together with the CIFAR-10
dataset.
"""
import numpy as np
