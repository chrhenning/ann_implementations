...
"""
@title           :examples/celeba_dcgan.py
@author          :ch
...
This script shows how to use the class DCGAN together with the CelebA
dataset.
"""
import numpy as np
